"""Module for running argument parser and running read_and_process."""
...
DEFAULT_INPUT_DIR = "/path/to/default_input_directory"
DEFAULT_OUTPUT_DIR = "/path/to/default_output_directory"
...
def main():
    """
    Main function for processing images and generating output CSV file.

    This function serves as the entry point for the application. It parses command-line
    arguments, sets input and output directories, processes images, performs OCR,
    processes extracted text, creates a DataFrame, and saves the DataFrame to a CSV file.
